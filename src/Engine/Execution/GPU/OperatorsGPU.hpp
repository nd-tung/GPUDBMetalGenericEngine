...
public:
    ...
    static MTL::Buffer* gatherU32(MTL::Buffer* in, MTL::Buffer* indices, uint32_t count);
    static MTL::Buffer* gatherF32(MTL::Buffer* in, MTL::Buffer* indices, uint32_t count);
